...
export async function generateMetadata({
  ...
  return {
    ...
    description: blog?.title || "Read this insightful post on our blog.",
    ...
    openGraph: {
      title: blog.title,
      description: blog.title || "Explore more insights on our blog.",
      type: "article",
      locale: "en_US",
      siteName: "Startup & SaaS Blog",
    },
    twitter: {
      title: blog.title,
      description: blog.title || "Check out this blog post.",
      card: "summary",
    },
  };
}
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  <div className="items-center justify-between sm:flex mt-4">
                    <div className="mb-5">
